...
// Server lists the tags service endpoint HTTP handlers.
type Server struct {
	Mounts []*MountPoint
	List   http.Handler
	Update http.Handler
...
// New instantiates HTTP handlers for all the tags service endpoints using the
...
func (s *Server) Service() string { return "tags" }
...
func (s *Server) MethodNames() []string { return tags.MethodNames[:] }

// Mount configures the mux to serve the tags endpoints.
...
// MountListHandler configures the mux to serve the "tags" service "list"
// endpoint.
func MountListHandler(mux goahttp.Muxer, h http.Handler) {
	...
	mux.Handle("GET", "/tags", f)
}

// NewListHandler creates a HTTP handler which loads the HTTP request and calls
// the "tags" service "list" endpoint.
func NewListHandler(
	...
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		ctx = context.WithValue(ctx, goa.ServiceKey, "tags")
...
// MountUpdateHandler configures the mux to serve the "tags" service "update"
// endpoint.
...
// MountDeleteHandler configures the mux to serve the "tags" service "delete"
// endpoint.
