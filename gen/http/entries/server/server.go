...
// Server lists the entries service endpoint HTTP handlers.
type Server struct {
	Mounts []*MountPoint
	Create http.Handler
	List   http.Handler
...
// New instantiates HTTP handlers for all the entries service endpoints using
...
func (s *Server) Service() string { return "entries" }
...
func (s *Server) MethodNames() []string { return entries.MethodNames[:] }

// Mount configures the mux to serve the entries endpoints.
...
// MountCreateHandler configures the mux to serve the "entries" service
// "create" endpoint.
...
func NewCreateHandler(
	...
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		ctx = context.WithValue(ctx, goa.ServiceKey, "entries")
...
// MountListHandler configures the mux to serve the "entries" service "list"
// endpoint.
func MountListHandler(mux goahttp.Muxer, h http.Handler) {
	...
	mux.Handle("GET", "/entries", f)
}

// NewListHandler creates a HTTP handler which loads the HTTP request and calls
// the "entries" service "list" endpoint.
func NewListHandler(
	endpoint goa.Endpoint,
	mux goahttp.Muxer,
	decoder func(*http.Request) goahttp.Decoder,
...
// MountGetHandler configures the mux to serve the "entries" service "get"
// endpoint.
...
// MountUpdateHandler configures the mux to serve the "entries" service
// "update" endpoint.
...
// MountDeleteHandler configures the mux to serve the "entries" service
// "delete" endpoint.
